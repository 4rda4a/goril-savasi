...
colorModeButtonDOM.addEventListener("click", () => {
  if (settings.mode === "dark") {
    settings.mode = "light";
    colorModeButtonDOM.innerText = "Koyu Mod";
  } else {
    settings.mode = "dark";
    colorModeButtonDOM.innerText = "Aydınlık Mod";
  }
  draw();
});
...
function announceWinner() {
  if (settings.numberOfPlayers === 0) {
    winnerDOM.innerText = `Robot ${state.currentPlayer}`;
    ...
    winnerDOM.innerText = `Robot`;
  } else {
    winnerDOM.innerText = `Oyuncu ${state.currentPlayer}`;
  }
  showCongratulations();
}
...
singlePlayerButtonDOM.forEach((button) =>
  button.addEventListener("click", () => {
    ...
    gameModeDOM.innerHTML = "Oyuncu vs. Robot";
    name1DOM.innerText = "Oyuncu";
    name2DOM.innerText = "Robot";
...
twoPlayersButtonDOM.forEach((button) =>
  button.addEventListener("click", () => {
    settings.numberOfPlayers = 2;
    gameModeDOM.innerHTML = "Oyuncu vs. Oyuncu";
    name1DOM.innerText = "Oyuncu 1";
    name2DOM.innerText = "Oyuncu 2";
...
autoPlayButtonDOM.forEach((button) =>
  button.addEventListener("click", () => {
    settings.numberOfPlayers = 0;
    name1DOM.innerText = "Robot 1";
    name2DOM.innerText = "Robot 2";
